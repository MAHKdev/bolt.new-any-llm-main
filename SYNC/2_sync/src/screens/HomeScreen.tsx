...
export function HomeScreen() {
  ...
  const [penalties] = useState<Penalty[]>([
    { id: '1', childId: '1', reason: 'Not cleaning toys', points: 10, date: '2024-03-10' },
  ]);
  ...
  return (
    <div className="space-y-8">
      ...
      <ChildCard
        child={activeChild}
        contracts={contracts.filter(c => c.childId === activeChild.id)}
        penalties={penalties.filter(p => p.childId === activeChild.id)}
